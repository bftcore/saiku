                ...
                */
                ...
                if(!same && row > lastHeaderRow && col < (colLen - measuresCount - 1) && lastRenderedRow != row && measuresCount > 0){
                  ...
                  if(col < prevColumnSum){
                    ...
                    contents += '<th class="row sums_row" ' + tipsy + '>' + 'Итого' + '</th><th class="row after_sums_row "' + tipsy + '" colspan="' + (colLen - prevColumnSum - measuresCount - 1) + '"' +'></th>';
                    for(z=0; z < measuresCount; z++){
                      contents += '<td class="data"><div>' + findSum(data, row - 1, prevColumnSum, colLen - measuresCount + z) + '</div></td>';
                    }
                    contents += '</tr><tr>';
                    prevColumnSum--;
                  ...
                  contents += '<th class="row sums_row" ' + tipsy + '>' + 'Итого' + '</th><th class="row after_sums_row "' + tipsy + '" colspan="' + (colLen - col - measuresCount - 1) + '"' +'></th>';
                  for(z=0; z < measuresCount; z++){
                    contents += '<td class="data"><div>' + findSum(data, row - 1, col, colLen - measuresCount + z) + '</div></td>';
                  }
                  itogRowExists = true;
                  prevColumnSum = col;
                  break;
